...
public class AnomanAuthenticationFailureHandler implements AuthenticationFailureHandler {

	private static final Logger logger = Logger.getLogger(AnomanAuthenticationFailureHandler.class);
