...
import com.RedirectWeb.Enums.STATUS;
 ...
 *
 */
@Component("imageVideoAuthenticationProvider")
public class AnomanAuthenticationProvider implements AuthenticationProvider {

	private static final Logger logger = Logger.getLogger(AnomanAuthenticationProvider.class);
